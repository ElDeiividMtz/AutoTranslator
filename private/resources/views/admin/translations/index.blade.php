...
@section('content')
            ...
            <div class="box" style="background: #1a2332; border: 1px solid #2a3a4e;">
                ...
                <div class="box-body">
                    ...
                    <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                        <form action="/extensions/autotranslator/translations/scan" method="POST" style="display: inline;">
                            @csrf
                                ...
                                <div class="col-md-4 col-sm-6" style="margin-bottom: 20px;">
                                    <div id="card-{{ $lang }}" style="background: #0d1520; border: 1px solid #2a3a4e; border-radius: 12px; padding: 20px; height: 100%;">
                                        ...
                                        <div id="btn-wrap-{{ $lang }}" style="display: flex; gap: 6px; flex-wrap: wrap;">
                                            ...
                                            <a href="/extensions/autotranslator/translations/export/{{ $lang }}" class="btn btn-sm" style="background: #2a3a4e; border: none; color: #8899aa; padding: 8px 12px; font-size: 12px; border-radius: 6px;" title="Export JSON">
    ...
    <script>
    var baseUrl = '/extensions/autotranslator/translations';
